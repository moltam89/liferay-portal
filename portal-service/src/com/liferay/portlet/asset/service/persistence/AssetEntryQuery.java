...
public class AssetEntryQuery {
	...
	public AssetEntryQuery(AssetEntryQuery assetEntryQuery) {
		...
		setNotAnyCategoryIdsArray(assetEntryQuery.getNotAnyCategoryIdsArray());
		setNotAnyTagIds(assetEntryQuery.getNotAnyTagIds());
		setNotAnyTagIdsList(assetEntryQuery.getNotAnyTagIdsList());
	...
	public void addNotAllCategoryIds(long[] notAllCategoryIds) {
		if (notAllCategoryIds.length == 0) {
			return;
		}

		setNotAllCategoryIds(
			ArrayUtil.append(_notAllCategoryIds, notAllCategoryIds));
	}
	...
	public void addNotAllTagIdsArray(long[] notAllTagsIds) {
		...
		setNotAllTagIdsArray(
			ArrayUtil.append(_notAllTagIdsArray, notAllTagsIds));
	}

	public void addNotAnyCategoryIdsArray(long[] notAnyCategoryIds) {
		if (notAnyCategoryIds.length == 0) {
			return;
		}

		setNotAnyCategoryIdsArray(
			ArrayUtil.append(_notAnyCategoryIdsArray, notAnyCategoryIds));
	}

	public void addNotAnyTagIdsArray(long[][] notAnyTagIds) {
		if (notAnyTagIds.length == 0) {
			return;
		}

		_notAnyTagIdsList.add(notAnyTagIds);
	...
	public long[][] getNotAnyCategoryIdsArray() {
		return _notAnyCategoryIdsArray;
	}
	...
	public List<long[][]> getNotAnyTagIdsList() {
		return _notAnyTagIdsList;
	}
	...
	public void setNotAnyCategoryIdsArray(long[][] notAnyCategoryIdsArray) {
		_notAnyCategoryIdsArray = notAnyCategoryIdsArray;
	...
	public void setNotAnyTagIdsList(List<long[][]> notAnyTagIdsArray) {
		_notAnyTagIdsList = notAnyTagIdsArray;
	...
	public String toString() {
		...
		sb.append(", notAnyCategoryIdsArray=");
		sb.append(_2DArrayToString(_notAnyCategoryIdsArray));
		sb.append(", notAnyTagIds=");
		sb.append(StringUtil.merge(_notAnyTagIds));
		sb.append(", notAnyTagIdsList=");
		sb.append(_tagIdsListToString(_notAnyTagIdsList));
	...
	private long[][] _notAnyCategoryIdsArray = new long[0][];
	private long[] _notAnyTagIds = new long[0];
	private List<long[][]> _notAnyTagIdsList = new LinkedList<long[][]>();
