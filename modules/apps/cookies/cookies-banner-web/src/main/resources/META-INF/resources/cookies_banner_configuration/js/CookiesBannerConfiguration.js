...
export default function () {
	...
	if (getCookie('COOKIES_CONSENT_TYPE_FUNCTIONAL') === 'true') {
		toggleFunctional.checked = true;
	}

	if (getCookie('COOKIES_CONSENT_TYPE_PERFORMANCE') === 'true') {
		togglePerformance.checked = true;
	}

	if (getCookie('COOKIES_CONSENT_TYPE_PERSONALIZATION') === 'true') {
