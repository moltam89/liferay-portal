...
public class DDMImplTest extends BaseDDMTestCase {
	...
	@Test
	public void testMergeFieldsAfterTranslationSaveUsingPreviousUI()
		throws Exception {

		DDMForm ddmForm = createDDMForm();

		addDDMFormFields(
			ddmForm, createTextDDMFormField(
					"Localizable", "", true, false, false));

		addDDMFormFields(
			ddmForm, createTextDDMFormField(
					"NonLocalizable", "", false, false, false));
		...
		Field newContentField = createBRField(
				ddmStructure.getStructureId(), "Localizable",
				createValuesList("Joao"));

		Field newFieldsDisplayField = createFieldsDisplayField(
			ddmStructure.getStructureId(),
			"Localizable_INSTANCE_ovho");
	...
	protected void testValues(
		String[] actualValues, String... expectedValues) {
