...
public class AssetCategoryPersistenceImpl extends BasePersistenceImpl<AssetCategory>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_LIKET_V =
		new FinderPath(AssetCategoryModelImpl.ENTITY_CACHE_ENABLED,
			AssetCategoryModelImpl.FINDER_CACHE_ENABLED,
			AssetCategoryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_LikeT_V",
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_LIKET_V =
		new FinderPath(AssetCategoryModelImpl.ENTITY_CACHE_ENABLED,
			AssetCategoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<AssetCategory> findByG_LikeT_V(long groupId, String title,
		long vocabularyId) throws SystemException {
		return findByG_LikeT_V(groupId, title, vocabularyId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> findByG_LikeT_V(long groupId, String title,
		long vocabularyId, int start, int end) throws SystemException {
		return findByG_LikeT_V(groupId, title, vocabularyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> findByG_LikeT_V(long groupId, String title,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_LIKET_V;
		finderArgs = new Object[] {
				groupId, title, vocabularyId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (AssetCategory assetCategory : list) {
				if ((groupId != assetCategory.getGroupId()) ||
						!StringUtil.wildcardMatches(assetCategory.getTitle(),
		...
		if (list == null) {
			...
			if (title == null) {
				query.append(_FINDER_COLUMN_G_LIKET_V_TITLE_1);
			}
			else if (title.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_G_LIKET_V_TITLE_3);
			}
			else {
				bindTitle = true;

				query.append(_FINDER_COLUMN_G_LIKET_V_TITLE_2);
			}
	...
	/**
	 * Returns the first asset category in the ordered set where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyId the vocabulary ID
	 ...
	 */
	@Override
	public AssetCategory findByG_LikeT_V_First(long groupId, String title,
		long vocabularyId, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		AssetCategory assetCategory = fetchByG_LikeT_V_First(groupId, title,
				vocabularyId, orderByComparator);
	 ...
	 */
	@Override
	public AssetCategory fetchByG_LikeT_V_First(long groupId, String title,
		long vocabularyId, OrderByComparator orderByComparator)
		throws SystemException {
		List<AssetCategory> list = findByG_LikeT_V(groupId, title,
				vocabularyId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last asset category in the ordered set where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyId the vocabulary ID
	 ...
	 */
	@Override
	public AssetCategory findByG_LikeT_V_Last(long groupId, String title,
		long vocabularyId, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		AssetCategory assetCategory = fetchByG_LikeT_V_Last(groupId, title,
				vocabularyId, orderByComparator);
	 ...
	 */
	@Override
	public AssetCategory fetchByG_LikeT_V_Last(long groupId, String title,
		long vocabularyId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_LikeT_V(groupId, title, vocabularyId);
	...
	/**
	 * Returns the asset categories before and after the current asset category in the ordered set where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param categoryId the primary key of the current asset category
	 * @param groupId the group ID
	 * @param title the title
	 ...
	 */
	@Override
	public AssetCategory[] findByG_LikeT_V_PrevAndNext(long categoryId,
		...
		try {
			...
			array[0] = getByG_LikeT_V_PrevAndNext(session, assetCategory,
					groupId, title, vocabularyId, orderByComparator, true);

			array[1] = assetCategory;

			array[2] = getByG_LikeT_V_PrevAndNext(session, assetCategory,
					groupId, title, vocabularyId, orderByComparator, false);
	...
	protected AssetCategory getByG_LikeT_V_PrevAndNext(Session session,
		AssetCategory assetCategory, long groupId, String title,
		long vocabularyId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyId the vocabulary ID
	 ...
	 */
	@Override
	public List<AssetCategory> filterFindByG_LikeT_V(long groupId,
		String title, long vocabularyId) throws SystemException {
		return filterFindByG_LikeT_V(groupId, title, vocabularyId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> filterFindByG_LikeT_V(long groupId,
		...
		throws SystemException {
		return filterFindByG_LikeT_V(groupId, title, vocabularyId, start, end,
			null);
	}

	/**
	 * Returns an ordered range of all the asset categories that the user has permissions to view where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> filterFindByG_LikeT_V(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeT_V(groupId, title, vocabularyId, start, end,
				orderByComparator);
		}
	...
	/**
	 * Returns the asset categories before and after the current asset category in the ordered set of asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param categoryId the primary key of the current asset category
	 * @param groupId the group ID
	 * @param title the title
	 ...
	 */
	@Override
	public AssetCategory[] filterFindByG_LikeT_V_PrevAndNext(long categoryId,
		long groupId, String title, long vocabularyId,
		OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeT_V_PrevAndNext(categoryId, groupId, title,
				vocabularyId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_LikeT_V_PrevAndNext(session, assetCategory,
					groupId, title, vocabularyId, orderByComparator, true);

			array[1] = assetCategory;

			array[2] = filterGetByG_LikeT_V_PrevAndNext(session, assetCategory,
					groupId, title, vocabularyId, orderByComparator, false);
	...
	protected AssetCategory filterGetByG_LikeT_V_PrevAndNext(Session session,
		AssetCategory assetCategory, long groupId, String title,
		long vocabularyId, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyIds the vocabulary IDs
	...
	@Override
	public List<AssetCategory> filterFindByG_LikeT_V(long groupId,
		String title, long[] vocabularyIds) throws SystemException {
		return filterFindByG_LikeT_V(groupId, title, vocabularyIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> filterFindByG_LikeT_V(long groupId,
		...
		throws SystemException {
		return filterFindByG_LikeT_V(groupId, title, vocabularyIds, start, end,
			null);
	}

	/**
	 * Returns an ordered range of all the asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> filterFindByG_LikeT_V(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeT_V(groupId, title, vocabularyIds, start, end,
				orderByComparator);
		}
		...
		query.append(_FINDER_COLUMN_G_LIKET_V_GROUPID_5);
		...
		if (title == null) {
			query.append(_FINDER_COLUMN_G_LIKET_V_TITLE_4);
		}
		else if (title.equals(StringPool.BLANK)) {
			query.append(_FINDER_COLUMN_G_LIKET_V_TITLE_6);
		}
		else {
			bindTitle = true;

			query.append(_FINDER_COLUMN_G_LIKET_V_TITLE_5);
		}
		...
		if ((vocabularyIds == null) || (vocabularyIds.length > 0)) {
			...
			for (int i = 0; i < vocabularyIds.length; i++) {
				query.append(_FINDER_COLUMN_G_LIKET_V_VOCABULARYID_5);
	...
	/**
	 * Returns all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> findByG_LikeT_V(long groupId, String title,
		long[] vocabularyIds) throws SystemException {
		return findByG_LikeT_V(groupId, title, vocabularyIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> findByG_LikeT_V(long groupId, String title,
		long[] vocabularyIds, int start, int end) throws SystemException {
		return findByG_LikeT_V(groupId, title, vocabularyIds, start, end, null);
	}

	/**
	 * Returns an ordered range of all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.asset.model.impl.AssetCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<AssetCategory> findByG_LikeT_V(long groupId, String title,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if ((vocabularyIds != null) && (vocabularyIds.length == 1)) {
			return findByG_LikeT_V(groupId, title, vocabularyIds[0], start,
				end, orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderArgs = new Object[] {
					groupId, title, StringUtil.merge(vocabularyIds)
				};
		}
		else {
			finderArgs = new Object[] {
		...
		List<AssetCategory> list = (List<AssetCategory>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_LIKET_V,
				finderArgs, this);

		if ((list != null) && !list.isEmpty()) {
			for (AssetCategory assetCategory : list) {
				if ((groupId != assetCategory.getGroupId()) ||
						!Validator.equals(title, assetCategory.getTitle()) ||
						!ArrayUtil.contains(vocabularyIds,
							assetCategory.getVocabularyId())) {
					list = null;
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_LIKET_V,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_LIKET_V,
					finderArgs);
	...
	/**
	 * Removes all the asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyId the vocabulary ID
	 ...
	 */
	@Override
	public void removeByG_LikeT_V(long groupId, String title, long vocabularyId)
		throws SystemException {
		for (AssetCategory assetCategory : findByG_LikeT_V(groupId, title,
				vocabularyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(assetCategory);
		}
	}
	...
	/**
	 * Returns the number of asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyId the vocabulary ID
	 ...
	 */
	@Override
	public int countByG_LikeT_V(long groupId, String title, long vocabularyId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_LIKET_V;

		Object[] finderArgs = new Object[] { groupId, title, vocabularyId };
	...
	/**
	 * Returns the number of asset categories where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyIds the vocabulary IDs
	 ...
	 */
	@Override
	public int countByG_LikeT_V(long groupId, String title, long[] vocabularyIds)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, title, StringUtil.merge(vocabularyIds)
			};

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_LIKET_V,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_LIKET_V,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_LIKET_V,
					finderArgs);
	...
	/**
	 * Returns the number of asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyId the vocabulary ID
	 ...
	 */
	@Override
	public int filterCountByG_LikeT_V(long groupId, String title,
		long vocabularyId) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_LikeT_V(groupId, title, vocabularyId);
		}
	...
	/**
	 * Returns the number of asset categories that the user has permission to view where groupId = &#63; and title LIKE &#63; and vocabularyId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param title the title
	 * @param vocabularyIds the vocabulary IDs
	...
	public int filterCountByG_LikeT_V(long groupId, String title,
		long[] vocabularyIds) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_LikeT_V(groupId, title, vocabularyIds);
		}
	...
	private static final String _FINDER_COLUMN_G_LIKET_V_GROUPID_2 = "assetCategory.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_LIKET_V_GROUPID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_LIKET_V_GROUPID_2) + ")";
	private static final String _FINDER_COLUMN_G_LIKET_V_TITLE_1 = "assetCategory.title LIKE NULL AND ";
	private static final String _FINDER_COLUMN_G_LIKET_V_TITLE_2 = "lower(assetCategory.title) LIKE ? AND ";
	private static final String _FINDER_COLUMN_G_LIKET_V_TITLE_3 = "(assetCategory.title IS NULL OR assetCategory.title LIKE '') AND ";
	private static final String _FINDER_COLUMN_G_LIKET_V_TITLE_4 = "(" +
		removeConjunction(_FINDER_COLUMN_G_LIKET_V_TITLE_1) + ")";
	private static final String _FINDER_COLUMN_G_LIKET_V_TITLE_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_LIKET_V_TITLE_2) + ")";
	private static final String _FINDER_COLUMN_G_LIKET_V_TITLE_6 = "(" +
		removeConjunction(_FINDER_COLUMN_G_LIKET_V_TITLE_3) + ")";
	private static final String _FINDER_COLUMN_G_LIKET_V_VOCABULARYID_2 = "assetCategory.vocabularyId = ?";
	private static final String _FINDER_COLUMN_G_LIKET_V_VOCABULARYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_LIKET_V_VOCABULARYID_2) + ")";
