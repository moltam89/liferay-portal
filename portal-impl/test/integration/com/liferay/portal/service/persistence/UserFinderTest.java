...
public class UserFinderTest {
	...
	public void testCountByKeywordsWithGroupUnion()
		...
		int userCount =
			UserFinderUtil.countByKeywords(
	...
	private User createApprovedUser(String screenName) throws Exception {
	...
	private void createGroupsWithUsers() throws Exception {
	...
	private List<User> findByKeywords(LinkedHashMap<String, Object> params)
		throws PortalException, SystemException {
