				...
				<c:choose>
					<c:when test="<%= PropsValues.JOURNAL_ARTICLES_SEARCH_WITH_INDEX %>">
						...
						for (int i = 0; i < searchResults.size(); i++) {
							...
							if (searchTerms.getStatusCode() == WorkflowConstants.STATUS_EXPIRED && Validator.isNotNull(article)) {
					...
					<c:otherwise>
						...
						%>
							...
							<%
							if (searchTerms.getStatusCode() == WorkflowConstants.STATUS_EXPIRED && Validator.isNotNull(curArticle)) {
