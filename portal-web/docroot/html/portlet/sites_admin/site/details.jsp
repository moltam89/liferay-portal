...
if (!disablePropagationCheckbox && (group != null) && (group.isStaged() || group.isStagedRemotely())) {
								...
								<c:choose>
									<c:when test="<%= hasUnlinkLayoutSetPrototypePermission %>">
										<div class="hide" id="<portlet:namespace />publicLayoutSetPrototypeIdOptions">
											...
											<aui:input disabled="<%= disablePropagationCheckbox %>" helpMessage="enable-propagation-of-changes-from-the-site-template-help" label="enable-propagation-of-changes-from-the-site-template" name="publicLayoutSetPrototypeLinkEnabled" type="checkbox" value="<%= publicLayoutSetPrototypeLinkEnabled %>" />
										</div>
									</c:when>
									<c:otherwise>
									...
									<c:when test="<%= group != null %>">
										...
										<c:choose>
											<c:when test="<%= (publicLayoutSetPrototype != null) && !liveGroup.isStaged() && hasUnlinkLayoutSetPrototypePermission %>">
												...
												<aui:input disabled="<%= disablePropagationCheckbox %>" label='<%= LanguageUtil.format(pageContext, "enable-propagation-of-changes-from-the-site-template-x", HtmlUtil.escape(publicLayoutSetPrototype.getName(user.getLanguageId())), false) %>' name="publicLayoutSetPrototypeLinkEnabled" type="checkbox" value="<%= publicLayoutSetPrototypeLinkEnabled %>" />
									...
									<c:when test="<%= group != null %>">
										...
										<c:choose>
											<c:when test="<%= (privateLayoutSetPrototype != null) && !liveGroup.isStaged() && hasUnlinkLayoutSetPrototypePermission %>">
												...
												<aui:input disabled="<%= disablePropagationCheckbox %>" label='<%= LanguageUtil.format(pageContext, "enable-propagation-of-changes-from-the-site-template-x", HtmlUtil.escape(privateLayoutSetPrototype.getName(user.getLanguageId())), false) %>' name="privateLayoutSetPrototypeLinkEnabled" type="checkbox" value="<%= privateLayoutSetPrototypeLinkEnabled %>" />
