...
String defaultDisplayStyle = PropsValues.BREADCRUMB_DISPLAY_STYLE_OPTIONS[0];

String displayStyle = PrefsParamUtil.getString(preferences, renderRequest, "displayStyle", Validator.isNotNull(defaultDisplayStyle) ? defaultDisplayStyle : "horizontal");
